...
---4. Lista las ventas totales de los productos que hayan facturado más de 3000 dólares. 
--Se mostrará el nombre, unidades vendidas, total facturado y total facturado con impuestos (13% IVA).
--ESTAS SI
SELECT 
  pr.nombre, 
