...
param_grid = {
    ...
    'min_samples_leaf': [1, 2, 4],  # Mínimas muestras por hoja
    'max_features': ['auto', 'sqrt', 'log2']  # Características a considerar en cada división
}
...
param_dist = {
    ...
    'max_depth': [10, 20, None],  # Profundidad máxima de los árboles
    'min_samples_split': randint(2, 10),  # Mínimas muestras para dividir un nodo
    'min_samples_leaf': randint(1, 5),  # Mínimas muestras por hoja
    'max_features': ['auto', 'sqrt', 'log2']  # Características a considerar en cada división
}
